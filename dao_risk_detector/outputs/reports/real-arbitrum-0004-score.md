...
**Proposal ID**: 77069694702187027448745871790562515795432836429094222862498991082283032976814
...
- Claimed actions: upgrade, upgrade, upgrade
...
The proposal text claims: This AIP introduces ArbOS Version 11, bringing improvements to Arbitrum chains including support for the EVM Shanghai upgrade (and PUSH0 opcode), retryable fixes, precompile fixes, and L1 pricing parameter updates. The upgrade applies to Arbitrum One and Arbitrum Nova.
