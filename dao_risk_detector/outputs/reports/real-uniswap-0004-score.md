...
The proposal text claims: A proposal for the Uniswap community to allocate 500k UNI to the Protocol Guild Pilot, an initiative that rewards Ethereum core protocol contributors through a vested split contract over a 1-year period to align incentives and support infrastructure maintenance.
