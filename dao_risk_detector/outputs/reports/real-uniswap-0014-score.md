...
The proposal text claims: A proposal to rebalance budgets for various Uniswap DAO programs by topping up their balances with 52,856 UNI ($280,142) to cover dollar-denominated commitments affected by token price fluctuations.
