...
**Proposal ID**: mutant-permission-0003
...
- `0x6000000000000000000000000000000000000003`
  - Risk level: CRITICAL
  - Related actions: grantRole(bytes32,address)
...
- Actual actions: permission_change
...
- **Key Evidence**:
  - Unaccounted addresses: 0x6000000000000000000000000000000000000003
...
The proposal text claims: This proposal updates configuration values without changing privileged operators.
The payload actually shows: permission_change. Decoded functions include: grantRole(bytes32,address).
