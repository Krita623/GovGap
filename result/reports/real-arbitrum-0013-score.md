...
**Proposal ID**: 108658450973990931334575713480652794742647878863726354508911679874665321261959
...
The proposal text claims: RnDAO proposes a two-phase, 6-month Hackathon Continuation Program in partnership with Arbitrum to co-fund and support top teams from the Arbitrum CollabTech Hackathon. The program aims to move projects from PoC to MVP, using funds transferred to the Arbitrum MSS.
