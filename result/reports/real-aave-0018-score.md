...
- Claimed actions: parameter_update, parameter_update, parameter_update, parameter_update, parameter_update, parameter_update
...
The proposal text claims: A proposal by Gauntlet to reactivate CRV borrowing on Aave v3 for both Ethereum and Polygon, alongside related parameter adjustments such as supplyCap, borrowCap, and debtCeiling.
