...
- Claimed actions: governance_proposal_creation, treasury_operation
...
The proposal text claims: Deploy Uniswap v3 to Boba Network, an Ethereum L2 scaling solution. The proposal requests a license exemption for Boba Network to use the Uniswap V3 Core software code. Boba Network will provide $1M in BOBA tokens to foster usage via a multisig wallet co-owned by the Uniswap Grants Program and Boba Network.
